                    ...
                    data-check-on-init="true">
                        ...
                        <?php foreach($contacts as $contact): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/profiles/user/edit/<?=$this->e($contact['id'])?>" class="btn btn-xs btn-warning me-4">
                                    ...
                                    <form class="delete" action="/profiles/user/delete/<?=$this->e($contact['id'])?>" method="POST" style="display: inline;">
